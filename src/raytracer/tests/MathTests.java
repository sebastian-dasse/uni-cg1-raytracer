...
public class MathTests extends TestCase {
	...
	public void testVectorOperations() {
		...
		Assert.assertEquals(new Point3(5, 4, 3),new Vector3(1, 1, 1).add(new Normal3(4, 3, 2)));
		Assert.assertEquals(new Point3(5, 4, 3),new Vector3(1, 1, 1).add(new Vector3(4, 3, 2)));
		Assert.assertEquals(new Point3(-3, -2, -1),new Vector3(1, 1, 1).sub(new Normal3(4, 3, 2)));
